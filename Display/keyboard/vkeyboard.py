...
class VKeyboard(Scatter):
    ...
    background = StringProperty(
        'atlas://data/newkeyboard//defaulttheme/vkeyboard_background')
    ...
    background_disabled = StringProperty(
        'atlas://data/newkeyboard//defaulttheme/vkeyboard_disabled_background')
    ...
    key_background_normal = StringProperty(
        'atlas://data/newkeyboard/defaulttheme/vkeyboard_key_normal')
    ...
    key_background_down = StringProperty(
        'atlas://data/newkeyboard//defaulttheme/vkeyboard_key_down')
    ...
    font_name = StringProperty('data/fonts/Roboto-Bold.ttf')
